...
def linsys_solver_str_to_int(settings):
    ...
    if linsys_solver_str == 'qdldl':
        settings['linsys_solver'] = constant('QDLDL_SOLVER')
    elif linsys_solver_str == 'mkl pardiso':
        settings['linsys_solver'] = constant('MKL_PARDISO_SOLVER')
...
def prepare_data(P=None, q=None, A=None, l=None, u=None, **settings):
    ...
    return ((n, m), P.data, P.indices, P.indptr, q, A.data, A.indices, A.indptr, l, u), settings
